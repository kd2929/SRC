           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                await client.send_video(
                    chat_id=sender,
                    video=path,
                    caption=caption.replace("𝐒𝚝𝚞𝚋𝚋𝘰𝚛η✿", "𝐑𝐄𝐗𝐎𝐃𝐀𝐒 🇮🇳").replace("(1280x720) 𝚂𝚝𝚞𝚋𝚋𝚘𝚛𝚗.mkv", ".mp4").replace("𝐌𝐚𝐭𝐡𝐬 𝐒𝐩𝐞𝐜𝐢𝐚𝐥 𝐏𝐫𝐚𝐜𝐭𝐢𝐜𝐞 𝐋𝐢𝐯𝐞 𝐁𝐚𝐭𝐜𝐡 𝐁𝐲 𝐏𝐚𝐰𝐚𝐧 𝐑𝐚𝐨 𝐒𝐢𝐫 𝐅𝐫𝐨𝐦 𝟏𝟓𝐭𝐡 𝐌𝐚𝐫𝐜𝐡 𝟐𝟎𝟐𝟒", "Math Special Practice Live Batch | 15 March 2024 | Pawan Rao Sir @Rexodas2023").replace("Batch Name :", "**Batch Name :**").replace("Downloaded by", "**Downloaded By**"),
                ...
                await client.send_document(
                    sender,
                    path, 
                    caption=caption.replace("𝐒𝚝𝚞𝚋𝚋𝘰𝚛η✿", "𝐑𝐄𝐗𝐎𝐃𝐀𝐒 🇮🇳").replace("(1280x720) 𝚂𝚝𝚞𝚋𝚋𝚘𝚛𝚗.mkv", "1280×720.mp4").replace("𝐌𝐚𝐭𝐡𝐬 𝐒𝐩𝐞𝐜𝐢𝐚𝐥 𝐏𝐫𝐚𝐜𝐭𝐢𝐜𝐞 𝐋𝐢𝐯𝐞 𝐁𝐚𝐭𝐜𝐡 𝐁𝐲 𝐏𝐚𝐰𝐚𝐧 𝐑𝐚𝐨 𝐒𝐢𝐫 𝐅𝐫𝐨𝐦 𝟏𝟓𝐭𝐡 𝐌𝐚𝐫𝐜𝐡 𝟐𝟎𝟐𝟒", "Math Special Practice Live Batch | 15 March 2024 | Pawan Rao Sir").replace("Batch Name :", "**Batch Name : **").replace("𝚂𝚝𝚞𝚋𝚋𝚘𝚛𝚗.pdf", "PDF").replace("Downloaded by", "**Downloaded By**"),
                    thumb=thumb_path,
                    progress=progress_for_pyrogram,
                    progress_args=(
                        client,
