           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                await client.send_video(
                    chat_id=sender,
                    video=path,
                    caption=caption.replace("@ImTgLoki", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("@LokiTheRobot", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("@TgLokii", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("BHAUKAL❤️", "**Bot Made By ＡＳＵＲ**").replace("#BHAUKAL❤️", "**Bot Made By ＡＳＵＲ**").replace("BHAUKAL💖", "**Bot Made By ＡＳＵＲ**").replace("#PHILLIP_&_INFINITE", "**Uploaded By : ＡＳＵＲ**\n`@AsurTalkBot`").replace("Downloaded by Bot of @GParle", "").replace("🅱🅰🅰🆉🅸🅶🅰🆁", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("Batch", "**Batch**").replace("Downloaded By:", "**Downloaded By : **").replace("Uploaded By:", "**Uploaded By : **").replace("Download By :", "**Download By :**").replace(":", "** :**").replace("Batch »", "**Batch :**").replace("Downloaded by »", "**Downloaded By : **").replace("_", " ").replace("@Hacktiva.mp4", ".mp4\n`Downloaded Using Bot of REXODAS 🇮🇳`"),
                ...
                await client.send_document(
                    sender,
                    path, 
                    caption=caption.replace("@ImTgLoki", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("@LokiTheRobot", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("@TgLokii", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("BHAUKAL❤️", "**Bot Made By ＡＳＵＲ**").replace("#BHAUKAL❤️", "**Bot Made By ＡＳＵＲ**").replace("BHAUKAL💖", "**Bot Made By ＡＳＵＲ**").replace("#PHILLIP_&_INFINITE", "**Uploaded By : ＡＳＵＲ**\n`@AsurTalkBot`").replace("Downloaded by Bot of @GParle", "").replace("🅱🅰🅰🆉🅸🅶🅰🆁", "**ＡＳＵＲ**\n`@AsurTalkBot`").replace("Batch", "**Batch**").replace("Downloaded By:", "**Downloaded By : **").replace("Uploaded By:", "**Uploaded By : **").replace("Download By :", "**Download By :**").replace(".pdf", "").replace(":", "** :**").replace("Batch »", "**Batch :**").replace("Downloaded by »", "**Downloaded By : **").replace("Description:", "**Description : **").replace("_", " ").replace("@Hacktiva", ""),
                    thumb=thumb_path,
                    progress=progress_for_pyrogram,
                    progress_args=(
                        client,
