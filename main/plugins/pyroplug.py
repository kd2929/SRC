           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg']:
                ...
                await client.send_document(
                    sender,
                    path, 
                    caption=caption.replace("@ImTgLoki", "**ＡＳＵＲ**\n`@AsurReborn_bot`").replace("@LokiTheRobot", "**ＡＳＵＲ**\n`@AsurReborn_bot`").replace("@TgLokii", "**ＡＳＵＲ**\n`@AsurReborn_bot`").replace("BHAUKAL❤️", "**Bot Made By ＡＳＵＲ**").replace("#BHAUKAL❤️", "**Bot Made By ＡＳＵＲ**").replace("BHAUKAL💖", "**Bot Made By ＡＳＵＲ**").replace("#PHILLIP_&_INFINITE", "**Uploaded By : ＡＳＵＲ**\n`@AsurReborn_bot`").replace("Downloaded by Bot of @GParle", "").replace("🅱🅰🅰🆉🅸🅶🅰🆁", "**ＡＳＵＲ**\n`@AsurReborn_bot`").replace("Batch", "**Batch**").replace("Downloaded By:", "**Downloaded By : **").replace("Uploaded By:", "**Uploaded By : **").replace("Download By :", "**Download By :**").replace(".pdf", "").replace(":", "** :**").replace("Batch »", "**Batch :**").replace("Downloaded by »", "**Downloaded By : **").replace("Description:", "**Description : **"),
                    thumb=thumb_path,
                    progress=progress_for_pyrogram,
                    progress_args=(
                        client,
