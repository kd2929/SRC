...
async def get_msg(userbot, client, sender, edit_id, msg_link, i, file_n):
    ...
    if 't.me/c/'  in msg_link or 't.me/b/' in msg_link:
        ...
        edit = await client.edit_message_text(sender, group_chat_id, edit_id, "Cloning....!", parse_mode="Markdown")
...
async def get_bulk_msg(userbot, client, sender, msg_link, i):
    x = await client.send_message(group_chat_id, "Processing....!", parse_mode="Markdown")
    file_name = ''
